...
aws s3 put /usr/local/bin/cropdroid $ARTIFACTS_BUCKET/cropdroid
aws s3 put /usr/local/bin/cockroach $ARTIFACTS_BUCKET/cockroach
aws s3 put /usr/local/lib/librocksdb.* $ARTIFACTS_BUCKET/